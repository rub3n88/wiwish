      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-lg shadow-sm p-4">
          <div className="flex items-center">
            <div className="rounded-full bg-baby-blue-100 p-3 mr-4">
              <Package className="h-5 w-5 text-baby-blue-500" />
            </div>
            <div>
              <p className="text-soft-gray-500 text-sm">Total de regalos</p>
              <p className="text-2xl font-bold text-soft-gray-800">{totalGifts}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          <div className="flex items-center">
            <div className="rounded-full bg-baby-pink-100 p-3 mr-4">
              <GiftIcon className="h-5 w-5 text-baby-pink-500" />
            </div>
            <div>
              <p className="text-soft-gray-500 text-sm">Regalos reservados</p>
              <p className="text-2xl font-bold text-soft-gray-800">{reservedGifts}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-soft-gray-800">{visitors}</p>
            </div>
          </div>
        </div>
      </div>
