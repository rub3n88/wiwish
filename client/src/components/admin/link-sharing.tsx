...
export function LinkSharing({ registryId, registrySlug }: LinkSharingProps) {
  ...
  const shareByWhatsapp = () => {
    const text = encodeURIComponent(
      `¡Hola! Aquí está el enlace a mi lista de regalos para bebé: ${registryUrl}`
    );
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-4 mb-8">
      <h3 className="font-bold text-soft-gray-800 mb-3">
        Enlace público de la lista
      </h3>
          ...
          <div className="flex gap-2">
            <div className="relative flex-grow">
              <input
                ...
                value={registryUrl}
                readOnly
                className="w-full px-4 py-2 pr-10 border border-soft-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-safari-green-500 focus:border-safari-green-500 bg-soft-gray-50"
              />
              <button
