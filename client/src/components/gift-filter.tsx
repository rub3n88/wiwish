    ...
    <div className="mb-6">
      <div className="relative">
        <input 
          ...
          className="w-full pl-10 pr-4 py-2 border border-soft-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-baby-blue-500 focus:border-baby-blue-500"
          value={query}
